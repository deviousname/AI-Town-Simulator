...
town_stuff = ["tavern", "general store", "blacksmith", "church", "graveyard", "school", "library", "police station",
              "fire station", "hospital", "bank", "post office", "train station", "bus station", "park", "lake", "river",
              "forest", "mountain", "farm", "ranch", "factory", "mine", "quarry", "lumber mill", "power plant", "wind farm",
              "solar farm", "nuclear power plant", "water treatment plant", "sewage treatment plant", "recycling center",
              "dump", "city hall", "courthouse", "jail", "prison", "museum", "zoo", "botanical garden", "planetarium",
              "aquarium", "theater", "movie theater", "concert hall", "stadium", "sports arena", "golf course",
              "tennis court", "basketball court", "baseball field", "football field", "soccer field", "hockey rink",
              "bowling alley", "skating rink", "pool hall", "billiards hall", "casino", "hotel", "motel", "bed and breakfast",
              "hostel", "campground", "beach", "lighthouse", "pier", "dock", "marina", "boat launch", "boat rental",
              "boat repair", "boat storage", "boat dealership", "car dealership"]
town_name = random.choice(first_names) + ' ' + random.choice(last_names) + ' ' + random.choice(['Town', 'City', 'Village', 'Hamlet', 'Burg',
                                                                                                'Borough', 'Municipality', 'County', 'Parish',
                                                                                                'Precinct', 'District', 'Region', 'Province',
                                                                                                'State', 'Territory', 'Country', 'Nation',
                                                                                                'Empire', 'Kingdom', 'Republic', 'Commonwealth',
                                                                                                'Principality', 'Duchy'])
...
world_name = random.choice(first_names) + ' ' + random.choice(last_names) + ' ' + random.choice(['World', 'Planet', 'Moon', 'Asteroid', 'Comet', 'Star',
                                                                                                 'Galaxy', 'Universe', 'Multiverse', 'Dimension', 'Realm',
                                                                                                 'Plane', 'Domain', 'Sphere', 'Sphere of Influence',
                                                                                                 'Sphere of Existence', 'Sphere of Reality', 'Sphere of Life',
                                                                                                 'Sphere of Death', 'Sphere of Time', 'Sphere of Space',
                                                                                                 'Sphere of Matter', 'Sphere of Energy', 'Sphere of Light',
                                                                                                 'Sphere of Darkness', 'Sphere of Good', 'Sphere of Evil',
                                                                                                 'Sphere of Law', 'Sphere of Chaos', 'Sphere of Order',
                                                                                                 'Sphere of Entropy', 'Sphere of Creation', 'Sphere of Destruction',
                                                                                                 'Sphere of Balance', 'Sphere of Imbalance'])
